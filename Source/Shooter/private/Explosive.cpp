...
void AExplosive::BulletHit_Implementation(FHitResult HitResult, AActor* Shooter, AController* ShooterConstroller)
{
	if (ImpactSound)
	{
	...
	for (auto Actor : OverlappingActors)
	{
		...
		UGameplayStatics::ApplyDamage(Actor, Damage, ShooterConstroller, Shooter, UDamageType::StaticClass());
	}
